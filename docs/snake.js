...
(function(exports) {
  ...
  var render = function (v) {
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
          var v1 = Graphics_Canvas.getCanvasElementById("snake")();
          var __unused = function (dictPartial1) {
          ...
          return __unused()((function () {
              if (v1 instanceof Data_Maybe.Just) {
                  return function __do() {
                      ...
                      var v3 = $foreign.setScore(v.score);
                      var v4 = Graphics_Canvas.clearRect(v2)({
                          x: 0.0,
                          y: 0.0,
                      ...
                      var v5 = Graphics_Canvas.setFillStyle("#000000")(v2)();
                      var v6 = Graphics_Canvas.fillRect(v2)({
                          x: 0.0,
                          y: 0.0,
                          w: Snake_Types.blockSize * Snake_Types.boardSize + 2.0 * Snake_Types.ref,
                          h: Snake_Types.blockSize * Snake_Types.boardSize + 2.0 * Snake_Types.ref
                      })();
                      var v7 = Graphics_Canvas.setFillStyle("#FFFFFF")(v2)();
                      var v8 = Graphics_Canvas.fillRect(v2)({
                          x: Snake_Types.ref,
                          y: Snake_Types.ref,
                          w: Snake_Types.blockSize * Snake_Types.boardSize,
                          h: Snake_Types.blockSize * Snake_Types.boardSize
                      })();
                      var v9 = Graphics_Canvas.setFillStyle("#000000")(v2)();
                      var v10 = Graphics_Canvas.fillRect(v2)({
                      ...
                      return Control_Monad_Eff.foreachE(v.snake)(function (v11) {
                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                              var v12 = Graphics_Canvas.setFillStyle("#000000")(v2)();
                              return Graphics_Canvas.fillRect(v2)({
                                  x: Snake_Types.blockSize * Data_Int.toNumber(v11.value0) + Snake_Types.ref + 1.0,
                                  y: Snake_Types.blockSize * Data_Int.toNumber(v11.value1) + Snake_Types.ref + 1.0,
              ...
              throw new Error("Failed pattern match at Snake.Render line 16, column 3 - line 17, column 3: " + [ v1.constructor.name ]);
          })())();
      });
  };
...
(function(exports) {
  ...
  var inBound = function (s) {
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          return x >= 0 && (y >= 0 && (x < Data_Int.floor(Snake_Types.boardSize - 1.0) && (y < Data_Int.floor(Snake_Types.boardSize - 1.0) && !Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Tuple.eqTuple(Data_Eq.eqInt)(Data_Eq.eqInt))(v.value0.head)(v.value0.tail))));
      };
